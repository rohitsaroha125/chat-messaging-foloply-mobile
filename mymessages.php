...
if(chrome==true)
{
	document.getElementById("searchicon").style.marginLeft="51.5%";
}
}
...
<br><br>
<div id="followingbox">
<div id="heading"><b>Inbox</b></div><br>
<?php
...
else
{
	...
	$selectquery="select max(id) as id from messages where userfrom='$msg' || userto='$msg' group by replyid order by id desc limit $page1,10";
...
{
echo ceil($newminute)." minutes ago";
}
if($timediff>3600 && $timediff<86400)
{
echo ceil($newhour)." hours ago";
}
if($timediff>86400 && $newdiff>=1 && $newdiff<=30)
{
	echo $newdiff." days ago";
}
...
if($lastnumber!=1)
{
	...
	{
		$pagenum=$pagenum+1;
		echo '<center><a href="messages.php?page='.$pagenum.'"><div id="fornext"><b>Next page</b></div></a></center>';
	}
}
else
{
